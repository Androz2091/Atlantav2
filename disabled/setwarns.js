...
module.exports.run = async (message, args, bot, emotes, data) => {
    ...
    if(sanction === 'reset'){
        for(var sanction in data.guild_data.warns_sanctions){
            ...
            if(nb === nombre){
                var nobject = {};
                var object = data.guild_data.warns_sanctions;
                for(var s in data.guild_data.warns_sanctions){
                    if(s !== sanction) nobject[sanction] = data.guild_data.warns_sanctions[sanction];
                }
                servers_data.set(message.guild.id+'.warns_sanctions', sanction);
